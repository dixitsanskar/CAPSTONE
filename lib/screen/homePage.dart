...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(
      builder: (controller) {
        return controller.presed ? _SearchPage() : _home();
      },
    );
  }
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                text: 'ollaborative ',
                                style: TextStyle(
                                    fontSize: 20, color: darkColorShade),
                              ),
                              TextSpan(
                                text: 'A',
                                style: TextStyle(
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Expanded(child: GetBuilder<searchhController>(
            builder: (_) {
              return HandlingDataView(
                statusRequest: searchController.statusRequest,
                widget: SingleChildScrollView(
                  child: Column(
                    children: List.generate(
                        searchController.searchResuts.length,
                        (index) => GestureDetector(
                              onTap: () {
                                Get.toNamed(Routes.psscreen, arguments: {
                                  'searchData':
                                      searchController.searchResuts[index]
                                });
                              },
                              child: InfoCard(
                                  title: searchController
                                      .searchResuts[index].title,
                                  description: searchController
                                      .searchResuts[index].problemStatement,
                                  percentage: searchController
                                      .searchResuts[index].percentage
                                      .toString()),
                            )),
                  ),
                ),
